                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium txet-white bg-pink-600 border border-gray-300 cursor-default leading-5 dark:bg-pink-600 dark:border-gray-600">{{ $page }}</span>
                                            </span>
                                        @else
